...
namespace FoodDelivery.Delivery_IntegrationTesting
{
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                services.AddDbContext<DeliveryDbContext>(options =>
                    options.UseInMemoryDatabase("DeliveryTestDb_" + Guid.NewGuid()));

                // Replace Hangfire SQL Server with MemoryStorage
                ...
                mockEmail.Setup(e => e.SendDeliveryOtpEmailAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>(), It.IsAny<DateTime>()))
                         .ReturnsAsync(true);
                mockEmail.Setup(e => e.SendPasswordResetOtpEmailAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<DateTime>()))
                         .ReturnsAsync(true);
                ...
                services.PostConfigure<Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerOptions>(
                    ...
                    options =>
                    {
                        var key = new Microsoft.IdentityModel.Tokens.SymmetricSecurityKey(
                            System.Text.Encoding.UTF8.GetBytes("YourSuperSecretKeyHere12345678901234567890"));
